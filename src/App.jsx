  ...
  return (
    <div className="bg-slate-100 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <nav className="rounded bg-blue-900 text-white px-2 py-2.5 sm:px-4">
          <div className="container mx-auto flex flex-wrap items-center justify-betwee">
            <a href="https://blabla.com" className="flex items-center">
              Blabla.com</a>
          </div>
